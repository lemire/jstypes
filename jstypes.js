...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'jstypes.wast';
  var wasmBinaryFile = 'jstypes.wasm';
  var asmjsCodeFile = 'jstypes.temp.asm.js';
...
if (!Module["stackAlloc"]) Module["stackAlloc"] = function() { abort("'stackAlloc' was not exported. add it to EXTRA_EXPORTED_RUNTIME_METHODS (see the FAQ)") };Module["ALLOC_NORMAL"] = ALLOC_NORMAL;
